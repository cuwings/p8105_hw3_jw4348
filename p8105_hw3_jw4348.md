...
- This plot provides a clear visualization of comparison of total
  ...
  - For people whose educational level is **high school equivalent**,
    ...
    their total activity generally **decrease** when they are
    older.**Women** are generally have **greater** total activities in
    most of the age compared to men. Also, there is a **small increase**
    for **women** in total activity around age **60 to 70** against the
  ...
  - For **women** whose educational level is **more than high school**,
    ...
    **increase before 40**, and **decrease after 40** when they aged.
